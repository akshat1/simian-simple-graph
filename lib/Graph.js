 ...
 * @static
 * @param {Graph} g -
 * @returns {ISet<Edge>} - Immutable set of edges from graph g.
*/
 ...
 * @static
 * @param {Graph} g -
 * @returns {ISet<Node>} - Immutable set of nodes from graph g.
 */
 ...
 * @param {Graph} g -
 * @param {Node} node -
 * @returns {ISet<Edge>} - Immutable set of all the edges leading out of Node node in Graph g.
 */
 ...
 * @param {Graph} g -
 * @param {Node} node -
 * @return {Graph} - the subtree of Graph g, rooted at Node node.
 */
 ...
 * @param {Graph} graph -
 * @param {Node} node -
 * @returns {ISet<Node>} - immutable set of all the nodes that descend from this node.
 */
...
/**
 * Returns all the ancestors of this node. Don't assume ancestors to be ancestors of each other.
 *
 * @function
 * @static
 * @param {Graph} g -
 * @param {Node} node -
 * @returns {ISet<Node>} - all the ancestors of this node
 */
 ...
 * @param {Node} node -
 * @param {Function} fn - Function of the form `fn(Node n, Node[] ancestors)` that will be called for each node in the subtree.
 * @param {Function} [sortEdges] - Function of the form `Edge[]: sortEdges(Edge[] edges, Node[] ancestors)`
